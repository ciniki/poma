...
function ciniki_poma_orderItemDelete(&$ciniki) {
    ...
    $rc = ciniki_poma_checkAccess($ciniki, $args['business_id'], 'ciniki.poma.orderItemDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectCheckUsed($ciniki, $args['business_id'], 'ciniki.poma.orderItem', $args['item_id']);
    if( $rc['stat'] != 'ok' ) {
    ...
    // Remove the item
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['business_id'], 'ciniki.poma.orderitem',
