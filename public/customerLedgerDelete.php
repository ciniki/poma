...
function ciniki_poma_customerLedgerDelete(&$ciniki) {
    ...
    $rc = ciniki_poma_checkAccess($ciniki, $args['tnid'], 'ciniki.poma.customerLedgerDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
...
return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.poma.113', 'msg'=>'Not yet implemented'));
    ...
    $rc = ciniki_core_objectCheckUsed($ciniki, $args['tnid'], 'ciniki.poma.customerLedger', $args['entry_id']);
    if( $rc['stat'] != 'ok' ) {
    ...
    // Remove the entry
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.poma.customerledger',
