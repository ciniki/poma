...
function ciniki_poma_settingsUpdate(&$ciniki) {
    ...
    $changelog_fields = array(
        ...
        'dates-open-auto',
        'dates-open-offset',
        'dates-open-offset-mon',
        'dates-open-offset-tue',
        'dates-open-offset-wed',
        'dates-open-offset-thu',
        'dates-open-offset-fri',
        'dates-open-offset-sat',
        'dates-open-offset-sun',
        'dates-open-time',
        'dates-lock-auto',
        'dates-lock-offset',
        'dates-lock-offset-mon',
        'dates-lock-offset-tue',
        'dates-lock-offset-wed',
        'dates-lock-offset-thu',
        'dates-lock-offset-fri',
        'dates-lock-offset-sat',
        'dates-lock-offset-sun',
        'dates-lock-time',
