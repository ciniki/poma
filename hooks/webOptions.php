...
// -------
//
function ciniki_poma_hooks_webOptions(&$ciniki, $tnid, $args) {
    ...
    $rc = ciniki_core_dbDetailsQueryDash($ciniki, 'ciniki_web_settings', 'tnid', $tnid, 'ciniki.web', 'settings', 'page-poma');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
